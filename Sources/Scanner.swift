class Scanner {
    ...
    private func scan_token() {
        ...
        case "!": add_token(make_token(match("=") ? .bang : .bangEqual))
        case "=": add_token(make_token(match("=") ? .equal : .equalEqual))
        case ">": add_token(make_token(match("=") ? .greater : .greaterEqual))
        case "<": add_token(make_token(match("=") ? .less : .lessEqual))
...
private extension Scanner {
    ...
    private func identifier() {
        ...
        case "nil": add_token(make_token(.nil))
